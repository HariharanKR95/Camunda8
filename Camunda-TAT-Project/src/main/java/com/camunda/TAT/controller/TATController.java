package com.camunda.TAT.controller;
...
//	private String getElasticURL;
	...
	Logger logger = LoggerFactory.getLogger(TATController.class);
//	@Autowired
...
//	private Valuepojo value;
	...
	public String demo(@RequestBody String message) {
		...
		zeebeClient.newCreateInstanceCommand().bpmnProcessId("Emp").latestVersion().variables(message).send().join();
